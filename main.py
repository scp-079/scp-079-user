...
from plugins.functions.timers import backup_files, interval_min_ten, reset_data, update_admins, update_status
...
scheduler.add_job(interval_min_ten, "interval", minutes=10)
